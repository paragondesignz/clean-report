-- Setup script for service_types table
-- Run this in your Supabase SQL editor if you're getting errors creating service types
...
SELECT 'service_types table setup completed successfully!' as status; 